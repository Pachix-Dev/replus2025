  ...
  return (
    <>
      <div className='program-solar py-5'>
        <h1 className='title-speakers fw-bold text-uppercase text-center text-light mb-5 pb-5'>
          {t('program.title_2')}
        </h1>
        ...
        {/*<Container className=''>
          <Nav variant='tabs' defaultActiveKey='#day1'>
            <Nav.Item>
              <Nav.Link
                href='#day1'
                onClick={() => setPrograms(programSSM.stage_1)}
              >
            ...
            <Nav.Item>
              <Nav.Link
                href='#day2'
                onClick={() => setPrograms(programSSM.stage_2)}
              >
            ...
            <Nav.Item>
              <Nav.Link
                href='#day3'
                onClick={() => setPrograms(programSSM.stage_3)}
              >
              ...
              {programSolar?.april_17.map((program, index) => {
                return (
                  <Row className='align-items-start justify-content-center program-date-item text-white'>
                    ...
                    <Col lg={8} xs={12} md={9}>
                      <p className='text-start text-uppercase fs-2 fw-bold text-light'>
                        {i18n.language === 'en'
                          ? program?.title_en
                          : program?.title}
                      </p>
                      <p className='fs-5 text-uppercase fw-bolder fst-italic'>
                        {program.company}
                      </p>
                      <p className='text-position fs-5'>
                        {i18n.language === 'en'
                      ...
                      <p
                        ...
                        dangerouslySetInnerHTML={{
                          __html:
                            i18n.language === 'en'
                              ? program?.infoWorkshop_en
                              : program?.infoWorkshop,
                        }}
                      ></p>
                      <a
                        href='https://www.ibesalliance.org/events/energy-storage-masterclass-innovative-business-strategies-cutting-edge-technologies-and-intelligent-systems'
                        target='_blank'
                        className='fs-4 fw-semibold link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover'
                      >
                        {i18n.language === 'en'
                          ? program?.btnInfoWorkshop_en
                          : program?.btnInfoWorkshop}
                      </a>

                      <Row className=' d-flex justify-content-start mt-3'>
                        {program.person &&
                          program.person.map((infoSpeaker, index) => (
                            <Col
                              xs={4}
                              lg={4}
                              key=''
                            ...
                            >
                              ...
                              <p className='fw-bold'>
                                {' '}
                                {infoSpeaker.speakers_name} <br />
                                <spam className='fst-italic fw-normal'>
                                  {' '}
                                  {i18n.language === 'en'
                                    ? infoSpeaker.position_en
