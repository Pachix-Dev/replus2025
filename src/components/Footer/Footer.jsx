...
export function Footer() {
  ...
  return (
    <footer className='mt-5'>
      <Container fluid className='background-footer'>
        {/* <img
      ...
      <Container>
        <div className='footer-socialmedia mt-5'>
          ...
          <a
            href='https://www.linkedin.com/company/solarstoragemexico/'
            target='_blank'
            rel='noreferrer'
          >
            <svg
          ...
          <a
            href='https://twitter.com/SolarPowerMx'
            target='_blank'
            rel='noreferrer'
          ...
          <Col md>
            <Row className='mb-5'>
              ...
              <Col xs={8} md={12} lg={8}>
                ...
                <br />
                <a href='mailto:sandra.elias@igeco.mx' className=''>
